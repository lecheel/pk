...
impl MergeApp {
    pub fn new(cc: &eframe::CreationContext<'_>, initial_patch: Option<String>) -> Self {
        ...
        let mut app = Self {
            ...
            patch_text: initial_patch.clone().unwrap_or_default(),
            hunks: Vec::new(),
            current_hunk: 0,
            ...
            fmt_command: config.fmt_command,
            show_settings: false,
            show_llm_config: false,
            fmt_error: None,
            ...
            rustconcat_api_url: config.rustconcat_api_url,
            impl_tools: config.impl_tools,
